/**
 * EthanMS Cosmetic NPC - Dr. Lenu (9200100)
 * Full hair, face & skin changer. No coupons required.
 * Works in Henesys and Free Market (use !pnpc 9200100 to spawn her anywhere).
 *
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendSimple(
            "Hey there~! I'm #bDr. Lenu#k, your personal stylist!\r\n" +
