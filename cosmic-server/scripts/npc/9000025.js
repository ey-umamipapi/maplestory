/**
 * UmamiMS Skill NPC - Grendel the Really Old (9000025)
 * Teaches utility cross-class skills at max level. No cost.
 */

// [skillId, name, description]
var skills = [
    [4111006, "Flash Jump",     "Double jump. Great for mobility."],
    [4101004, "Haste",          "Boosts speed and jump permanently."],
    [2301001, "Teleport",       "Blink in any direction."],
    [1301007, "Hyper Body",     "Increases max HP and MP by 60%."],
    [2311003, "Holy Symbol",    "Boosts EXP and drop rate. Great for grinding."],
    [2311002, "Mystic Door",    "Creates a portal back to town."],
    [2001002, "Magic Guard",    "Redirects damage to MP instead of HP."],
    [5121009, "Speed Infusion", "Increases attack speed by 2 stages."],
    [4001003, "Dark Sight",     "Grants invisibility while standing still."],
    [5121010, "Time Leap",      "Resets all skill cooldowns."],
];
